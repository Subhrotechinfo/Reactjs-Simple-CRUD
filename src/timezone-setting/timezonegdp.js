...
let worldTimeZoneList = [
    ...
    },
    {
      ...
      "abbr": "AEST","countryCode":"AU",
      "offset": 10,
      "isdst": false,
      "text": "(UTC+10:00) Canberra, Melbourne, Sydney ,Brisbane,Guam, Port Moresby ,Hobart",
      "utc": [
        "Australia/Melbourne",
        "Australia/Sydney"
      ]
...
let marker1 = [
    ...
    {latLng: [42.4822,20.7458], name: 'Malishevë'}
    ];
...
export {worldTimeZoneList, gdpData, marker1 };
